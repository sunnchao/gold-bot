...
# AI 分析开关
# ============================================
# 控制是否启用 AI 研判模块（Aurex AI Agent）
# False 时：/api/ai_result 端点忽略 AI 结果，不执行 AI 建议的操作
# 用法：export ENABLE_AI=false 或在 .env 中设置
ENABLE_AI = os.getenv("ENABLE_AI", "false").lower() in ("true", "1", "yes", "on")
